			...
			<div >
				{this.state.askForUsername === true ?
					<div className="connectpage">
						<div style={{ width: "30%", height: "auto",borderRadius:5, padding: "20px",marginTop:"4px", minWidth: "400px",
								textAlign: "center",background: "rgba(245, 245, 245, 0.567)", margin: "auto",  justifyContent: "center"}}>
						...
						<div style={{ justifyContent: "center", textAlign: "center", paddingTop: "40px" }}>
							<video id="my-video" ref={this.localVideoref} autoPlay muted style={{
								borderRadius:20,borderColor: "#bdbdbd",objectFit: "fill",width: "59%",height: "59%"}}></video>
						</div>
					</div>
					:
					<div style={{ backgroundColor: "#CF8B41"}}>
